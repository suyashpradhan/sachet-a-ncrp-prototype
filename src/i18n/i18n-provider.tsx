...
const EN_TEXT: Record<string, string> = {
  ...
  "updates.foundSomething": "Found something new?",
  "updates.support": "Add new evidence or correct something you previously reported. Your original case will stay preserved.",
  "updates.addEvidence": "Add new evidence",
  "updates.correctDetail": "Correct or add a detail",
  "updates.chooseEvidence": "Choose evidence",
  "updates.useDemoEvidence": "Use synthetic call log",
  "updates.processingEvidence": "Reading evidence…",
  "updates.evidenceError": "We could not read this evidence. Try another image.",
  "updates.detailLabel": "Detail to add or correct",
  "updates.chooseDetail": "Choose a detail",
  "updates.updatedInformation": "Updated information",
  "updates.addNote": "Add a note (optional)",
  "updates.preview": "Preview update",
  "updates.previewHeading": "This will be added as a case update",
  "updates.originallyReported": "Originally reported",
  "updates.previously": "Previously",
  "updates.notKnown": "Not known",
  "updates.supportedBy": "Supported by",
  "updates.originalPreserved": "Original case preserved",
  "updates.addUpdate": "Add update",
  "updates.goBack": "Go back",
  "updates.savedLive": "Update saved to this Sachet case.",
  "updates.savedDemo": "Demo update added. No update was sent to NCRP or another external system.",
  "updates.history": "Case updates",
  "updates.number": "Update #{number}",
  "updates.type.NEW_EVIDENCE": "New evidence",
  "updates.type.NEW_INFORMATION": "New information",
  "updates.type.CORRECTION": "Correction",
  "updates.note": "Note",
  "privacy.used": "Used from this evidence",
  "privacy.kept": "Kept only in the original evidence",
  "privacy.notRepeated": "Sensitive details are not repeated here unless needed.",
  "privacy.principle": "Sachet carries forward only the details needed for the complaint or next step.",
  "privacy.authenticationCode": "Authentication code",
  "privacy.fullIdentifier": "Full account or card details",
  "privacy.unrelatedBalance": "Unrelated balance",
  "privacy.noneSensitive": "No additional sensitive details were carried forward.",
  "updates.originalComplaint": "Original complaint",
  "updates.fileUnavailable": "This file needs to be added again to view the original evidence.",
